...
<!-- MB: HOW TO ADD WHITESPACE for paragraph submissions?? -->
<!-- MB: How to not say submisions are incorrect -->
...
<!-- MB: This table won't show up for some reason? -->
...
question_text("What is Cassidy's outcome under treatment if we assume the causal value to be ATE?",
    allow_retry = T,
    answer("10.5", correct = T)
  ),
question_text("What is Tahmid's outcome under treatment if we assume the causal value to be ATE?",
    allow_retry = T,
...
question("Which of the following is NOT a reason why $\widehat{ATE}$ a useful estimand?",
    ...
    answer("$\widehat{ATE}$ always captures the correct sign (+ or -) of the true ATE", correct = TRUE),
    allow_retry = TRUE
  ),
question_text("How is $\widehat{ATE}$ different than ATE.",
    allow_retry = T,
    answer(NULL, correct = T)
  ),
...
<!-- section of book so this must be updated to match -->
...
# MORE QUESTIONS ON Predictive vs Causal
