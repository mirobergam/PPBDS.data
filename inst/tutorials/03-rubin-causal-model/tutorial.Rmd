...
question_text(
    "In your own words, what is a 'counterfactual'?",
    allow_retry = T,
...
question("What was the treatment effect percentage on Diego? (answer as +/-X0%)",
...
The console has provided for your convenience to solve for the ATE of this sample. Nothing you type in the console will be graded.
...
Answer the following questions on external validity, scale, and humility.
...
question_text("Humility is a key step in modelling and data analysis where we acknowledge all of the things in the real world that may have messed up our experiment or predictions. Use humility and discuss one of these things in a few sentences.", # MB: CASS
      allow_retry = T,
      answer(NULL, correct = T),
    incorrect = "Ok"
  )
...
<!-- MB: Rework this. Do weight loss example instead. Add more people? Whether or not the out of bounds number is possible vs impossible is another thing. Introduce the table better-->
...
# MB: Cass. Talk about the math at this point. Any mathmathical thing stops at the first eq. Redo formnula to annotate.
